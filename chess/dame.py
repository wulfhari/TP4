...
class Dame(Piece):
    ...
    def deplacementValide(self,nouvPos,plateau):
        ...
        # Si une piece à l'arrivee et identique à la couleur de la dame
        ...
        # Deplacement sur la meme ligne
            ...
            for i in range(depart,arrivee):
                if plateau.getPiece(pos_dep[0],i) != None:
                    return False
                    # Rendu ici, il n'y a pas de piece sur le chemin et la piece à l'arrivee
    ...
    """ Petit truc pour l'affichage """
        if self.color == 0:
            ...
            return "Reine Blanche"+str(self.pos)
...
def test_pos():
    ...
    p.damier[(3,0)] = dn
    p.damier.pop((0,3))
    dn.deplacer((7,3),p) # 3,0 -> 7,3 # Ne fais rien / mouvement non autorisé
    dn.deplacer((4,2),p) # 3,0 -> 4,2 # Ne fais rien / mouvement non autorisé
    print(dn)
